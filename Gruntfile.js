module.exports = function(grunt){
    grunt.initConfig({
        ...
        clean: {
            ...
            normalFiles: {
                src: ['dist/public/vendor', 'dist/public/js/controllers', 'dist/public/js/services', 'dist/public/js/main.js']
            }
        },
        usemin: {
    ...
    grunt.registerTask('default', ['dist', 'minify', 'clean:normalFiles']);
